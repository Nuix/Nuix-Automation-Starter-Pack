...
<metadata-profile xmlns="http://nuix.com/fbi/metadata-profile">
  <metadata-list>
    ...
    <metadata type="DERIVED" name="[Meta] Date Accessed" customDateFormat="yyyy-MM-dd">
      <metadata type="PROPERTY" name="File Accessed" />
    </metadata>
    <metadata type="DERIVED" name="[Meta] Date Accessed Time" customDateFormat="HH:mm:ss">
      <metadata type="PROPERTY" name="File Accessed" />
    </metadata>
    <metadata type="DERIVED" name="[Meta] Date Appmt Start Time" customDateFormat="HH:mm:ss">
      <first-non-blank>
    ...
    <metadata type="DERIVED" name="[Meta] Date Appmt Start" customDateFormat="yyyy-MM-dd">
      <first-non-blank>
        <metadata type="PROPERTY" name="Mapi-Cal-Start-Time" />
        <metadata type="PROPERTY" name="STARTDATETIME" />
    ...
    <metadata type="DERIVED" name="[Meta] Date Appmt End" customDateFormat="yyyy-MM-dd">
      <first-non-blank>
    ...
    <metadata type="DERIVED" name="[Meta] Date Appmt End Time" customDateFormat="HH:mm:ss">
      <first-non-blank>
        <metadata type="PROPERTY" name="Mapi-Cal-End-Time" />
        <metadata type="PROPERTY" name="EndDateTime" />
        <metadata type="PROPERTY" name="Mapi-Lid-Appointment-End-Whole" />
    ...
    <metadata type="DERIVED" name="[Meta] Date Created" customDateFormat="yyyy-MM-dd">
      <first-non-blank>
    ...
    <metadata type="DERIVED" name="[Meta] Date Created Time" customDateFormat="HH:mm:ss">
      <first-non-blank>
        <metadata type="PROPERTY" name="File Created" />
        <metadata type="PROPERTY" name="Created" />
        <metadata type="PROPERTY" name="Notes Created" />
    ...
    <metadata type="DERIVED" name="[Meta] Date Modified" customDateFormat="yyyy-MM-dd">
      <first-non-blank>
    ...
    <metadata type="DERIVED" name="[Meta] Date Modified Time" customDateFormat="HH:mm:ss">
      <first-non-blank>
        <metadata type="PROPERTY" name="File Modified" />
        <metadata type="PROPERTY" name="PDF Modified Date" />
        <metadata type="PROPERTY" name="Last Saved" />
    ...
    <metadata type="DERIVED" name="[Meta] Date Received" customDateFormat="yyyy-MM-dd">
      <first-non-blank>
        <metadata type="PROPERTY" name="Mapi-Message-Delivery-Time" />
        <metadata type="PROPERTY" name="DeliveredDate" />
      </first-non-blank>
    </metadata>
    <metadata type="DERIVED" name="[Meta] Date Received Time" customDateFormat="HH:mm:ss">
      <first-non-blank>
        <metadata type="PROPERTY" name="Mapi-Message-Delivery-Time" />
        <metadata type="PROPERTY" name="DeliveredDate" />
      </first-non-blank>
    </metadata>
    <metadata type="DERIVED" name="[Meta] Date Sent" customDateFormat="yyyy-MM-dd">
      <first-non-blank>
    ...
    <metadata type="DERIVED" name="[Meta] Date Sent Time" customDateFormat="HH:mm:ss">
      <first-non-blank>
        <metadata type="PROPERTY" name="Mapi-Client-Submit-Time" />
        <metadata type="PROPERTY" name="PostedDate" />
        <metadata type="PROPERTY" name="DeliveredDate" />
    ...
    <metadata type="DERIVED" name="[Meta] Date Top Family" customDateFormat="yyyy-MM-dd">
      <metadata type="SPECIAL" name="Top Level Item Date" />
    </metadata>
    <metadata type="DERIVED" name="[Meta] Date Top Family Time" customDateFormat="HH:mm:ss">
      <metadata type="SPECIAL" name="Top Level Item Date" />
    </metadata>
    <metadata type="DERIVED" name="[Meta] Office Property - Date Last Printed" customDateFormat="yyyy-MM-dd">
      <metadata type="PROPERTY" name="Last Printed" />
    </metadata>
    <metadata type="DERIVED" name="[Meta] Office Property - Date Last Saved" customDateFormat="yyyy-MM-dd">
      <first-non-blank>
        <metadata type="PROPERTY" name="Last Saved" />
        <metadata type="PROPERTY" name="PDF Modified Date" />
      </first-non-blank>
...
item.getFileSize()]]></script>
    ...
    <metadata type="DERIVED" name="[Meta] Office Property - Date Last Printed Time" customDateFormat="HH:mm:ss">
      <metadata type="PROPERTY" name="Last Printed" />
    </metadata>
